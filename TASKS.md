...
- [x] Fund reporting treatment controls: Added fund-level standard-reporting and cash-reconciliation treatment fields for active pooled cash/reconciliation funds, updated Fund import/manual edit/display behavior, and adjusted calculation mapping coverage/standard reporting filters so active excluded funds are valid but omitted from normal rollups.
