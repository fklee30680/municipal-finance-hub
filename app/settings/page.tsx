  ...
  return (
    <AppShell>
      <section className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Fiscal Year Setup</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="max-w-3xl text-sm leading-6 text-muted-foreground">
              Create fiscal years and periods for current and historical trial
              balance validation, including optional Period 0 and Period 13.
            </p>
            <Link
              className="inline-flex items-center rounded-md border border-border bg-card px-4 py-2 text-sm font-medium text-foreground hover:bg-muted focus:outline-none focus:ring-2 focus:ring-ring"
